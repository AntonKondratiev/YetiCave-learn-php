  ...
  <form class="form form--add-lot container form--invalid" action="/add.php" method="post"> <!-- form--invalid -->
    ...
    <div class="form__container-two">
      <div class="form__item <?php if (check_input($errors, 'lot_name') == true): ?> form__item--invalid <?php endif; ?>"> <!-- form__item--invalid -->
        <label for="lot-name">Наименование</label>
        <input id="lot-name" type="text" name="lot-name" placeholder="Введите наименование лота" value=<?= strip_tags($_POST['lot_name']) ?>>
